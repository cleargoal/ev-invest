...
class OperationSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $data = [
            ...
            [
                'title' => 'Прибуток від продажу',
                'description' => 'Нарахований прибуток спільноти від продажу авто після віднімання комісії компанії. Операція проводиться автоматично після продажу авто',
            ],
        ];
